...
# user_info
# 读取数据集
user_info_train = pd.read_csv('./data//train/user_info_train.txt',header = None)
user_info_test = pd.read_csv('./data//test/user_info_test.txt',header = None)
...
# 下面的处理方式类似，我仅注释不同的地方
# bank_detail
bank_detail_train = pd.read_csv('./data/train/bank_detail_train.txt',header = None)
bank_detail_test = pd.read_csv('./data/test/bank_detail_test.txt',header = None)
...
# browse_history
browse_history_train = pd.read_csv('./data/train/browse_history_train.txt',header = None)
browse_history_test = pd.read_csv('./data/test/browse_history_test.txt', header = None)
...
# bill_detail
bill_detail_train = pd.read_csv('./data/train/bill_detail_train.txt', header = None)
bill_detail_test = pd.read_csv('./data/test/bill_detail_test.txt',header = None)
...
# loan_time
loan_time_train = pd.read_csv('./data/train/loan_time_train.txt',header = None)
loan_time_test = pd.read_csv('./data/test/loan_time_test.txt',header = None)
...
target = pd.read_csv('./data/train/overdue_train.txt', header = None)
